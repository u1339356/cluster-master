...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc -std=gnu99' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -pthread -D__EXTENSIONS__' CPPFLAGS='  -I/home/lubo/openmpi-2.1.0/opal/mca/hwloc/hwloc1112/hwloc/include -I/home/lubo/openmpi-2.1.0/opal/mca/event/libevent2022/libevent -I/home/lubo/openmpi-2.1.0/opal/mca/event/libevent2022/libevent/include' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr/local --disable-aio --disable-weak-symbols --enable-strict"
...
#define OMPI_RELEASE_DATE "Mar 20, 2017"
...
#define OMPI_TARBALL_VERSION "2.1.0"
...
#define OPAL_IDENT_STRING "2.1.0"
...
#define OPAL_PACKAGE_STRING "Open MPI root@cluster-master Distribution"
...
#define OPAL_RELEASE_DATE "Mar 20, 2017"
...
#define OPAL_REPO_REV "v2.0.1-696-g1cd1edf"
...
#define OPAL_TARBALL_VERSION "2.1.0"
...
#define ORTE_RELEASE_DATE "Mar 20, 2017"
...
#define ORTE_REPO_REV "v2.0.1-696-g1cd1edf"

/* Tarball filename version string of Open MPI Run-Time Environment */
#define ORTE_TARBALL_VERSION "2.1.0"
...
#define OSHMEM_TARBALL_VERSION "2.1.0"
...
#define PACKAGE_STRING "Open MPI 2.1.0"
